...
public class ServeltTest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Vinos l1 = new Vinos(1, "nombre_vino1", 1, "pais_procedencia1", 1, true);
        Vinos l2 = new Vinos(2, "nombre_vino2", 2, "pais_procedencia2", 2, false);

        List<Vinos> Vinos = new ArrayList<Vinos>();
        Vinos.add(l1);
        Vinos.add(l2);

        Gson gson = new Gson();
        String result = gson.toJson(Vinos);
        response.setContentType("text/html;charset=UTF-8");
